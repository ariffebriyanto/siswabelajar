...
namespace Helper.DataAnnotation
{
    ...
    public class NumberGreaterEqualsThanAttribute : ValidationAttribute, IClientModelValidator
    {
        private readonly string _comparisonProperty;

        public NumberGreaterEqualsThanAttribute(string comparisonProperty)
        {
